...
The [onet2r](https://github.com/farach/onet2r) package provides access to the O\*NET Web Services API, which contains comprehensive U.S. occupational data including skills, knowledge requirements, tasks, abilities, and technology skills for thousands of occupations. Combining onet2r with foundryR supports analytical workflows such as:
