...
chat. foundryR is the better fit when the work is tied to Microsoft Foundry and
...
and use foundryR when you need Microsoft Foundry results as data -- and use
