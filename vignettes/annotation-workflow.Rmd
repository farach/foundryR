...
The rendered table and chart below use precomputed, illustrative data from a
representative run. They are rendered during the documentation build without
Azure credentials.

```{r review-table-rendered, eval = TRUE, echo = FALSE}
annotation_cache <- readRDS(foundryr_vignette_cache("annotation-workflow.rds"))
review <- annotation_cache$review
...
```{r sentiment-theme-chart, eval = TRUE, echo = FALSE, fig.alt = "Bar chart of survey response themes by sentiment."}
theme_counts <- review |>
