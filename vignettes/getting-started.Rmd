...
2. At least one chat or Responses API deployment, for example `gpt-4o-mini`.
...
> necessarily the base model name. If you deploy base model `gpt-4o-mini` with
> deployment name `my-gpt4`, use `model = "gpt-4.1"` in foundryR. The same rule
