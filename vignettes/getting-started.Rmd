...
(formerly Azure AI Foundry) projects. Before writing R code, create or identify:

1. An Azure OpenAI resource or Microsoft Foundry project with an OpenAI endpoint.
...
Endpoint** to copy the endpoint URL and an API key. In the Foundry portal, use the
