...
ggplot2::ggplot(severity_grid, ggplot2::aes(x = category, y = text)) +
  ...
  ggplot2::labs(
    title = severity_chart_title,
    subtitle = sprintf(
      "Severity by text and harm category (0 safe, 2 low, 4 medium, 6 high); review at %d or more",
      review_threshold
    ),
    x = NULL,
    y = NULL,
    caption = "foundry_moderate() results for the three sample texts above. Tiles darken as severity rises."
  ) +
