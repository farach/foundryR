...
checks whether an answer is supported by its sources. This endpoint is
preview and region-limited:
...
surfaces explicit. Run
[`vignette("api-support")`](https://farach.github.io/foundryR/articles/api-support.md)
for endpoint families, authentication audiences, API versions, and known
gaps.
