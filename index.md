...
AI-powered applications with chat completions, embeddings, content
safety, and image generation - all returning tibbles that integrate
seamlessly with tidyverse and tidymodels workflows.
