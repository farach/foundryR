...
#'
#' Create text embeddings using a Microsoft Foundry model as part of a tidymodels
...
#'   trained.
#' @param model Character. The deployment name of a Microsoft Foundry embedding
